...
* add markdown reporter and GitHub Action for CI scan reports ([fce3d2c](https://github.com/forbiddenlink/repro-in-a-box/commit/fce3d2cf3a56b2e4eb9f9e71e43fa6aa60d4e14a))
...
* **deps:** add pnpm-workspace overrides for security patches ([16ec68a](https://github.com/forbiddenlink/repro-in-a-box/commit/16ec68a64df83c717964090ffc75ebd538ba2160))
* **deps:** clear high CVEs via same-major overrides ([bc4fe2d](https://github.com/forbiddenlink/repro-in-a-box/commit/bc4fe2d3293a09ba8e37f6f08b28362cf20389a7))
* **deps:** pin pnpm and keep security overrides in package.json ([ae0118a](https://github.com/forbiddenlink/repro-in-a-box/commit/ae0118ad40a0204b636feca70acf56a7c69405d0))
